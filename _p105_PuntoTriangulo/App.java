...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Triangulo 1 - Vertice 1 : Punto " + triangulo1.getV1());
        System.out.println("Triangulo 1 - Vertice 2 : Punto " + triangulo1.getV2());
        System.out.println("Triangulo 1 - Vertice 3 : Punto " + triangulo1.getV3());
