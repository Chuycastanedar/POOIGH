// Imprime el menor de 4 numeros, usando una funcion.
...
public class _p75_NumeroMenor {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingresa cuatro numeros separados por espacio.\n");
        n1 = obj.nextInt(); n2 = obj.nextInt(); n3 = obj.nextInt(); n4 = obj.nextInt();

        System.out.printf("\nEl número menor de los 4 es el: %d",Menor(n1,n2,n3,n4));
    }
}